...
// .wrangler/tmp/bundle-Hbun9D/checked-fetch.js
  ...
  "../../../../../node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/dhairyabansal/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../Desktop/0-100 COHORT/week-13 Project#1/medium/.env"
      },
      "relativePath": "../../../Desktop/0-100 COHORT/week-13 Project#1/medium/prisma",
...
// node_modules/@100xdevs/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@100xdevs/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-Hbun9D/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-Hbun9D/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    ...
    let token = await sign2({ id: createdUser.id }, c.env.JWT_SECRET);
    return c.json({
      jwt: token
    });
  } catch (e) {
...
blogRouter.post("/", async (c) => {
  ...
  let prisma = new import_edge2.PrismaClient({
    datasourceUrl: c.env.DATABASE_URL
  }).$extends(withAccelerate());
  ...
  let createdBlog = await prisma.post.create({
    data: {
      ...
      authorId: author.id
      // Use the author ID from the authenticated user
    }
  });
  return c.json({
    createdBlog
